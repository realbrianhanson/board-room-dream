...
Deno.test("start_run plan: needs completed audit when both selected", () => {
  const w = deriveImportWorkflow({ goals: ["code_audit", "improvements"] });
